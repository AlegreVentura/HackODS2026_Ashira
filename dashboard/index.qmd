...
::: {.ashira-insight .accent-red}
Cada estado coloreado por su porcentaje de pobreza multidimensional en 2024. El patrón es inmediato: [**el norte es verde**]{style="color:#2ecc71;"}, [**el sur es rojo.**]{style="color:#e94560;"} No hay excepciones.
:::
...
El mapa de pobreza muestra dónde están las carencias. El mapa de ingreso muestra cuánto cambió el dinero disponible. [**Misma escala de color, ocho años de distancia.**]{style="color:#38bdf8;"} El patrón Norte–Sur se mantuvo: los estados que ya ganaban más en 2016 son los que más crecieron en términos absolutos.
:::
...
::: {.ashira-insight .accent-red}
Chiapas y Baja California comparten bandera y constitución. No comparten el mismo México. En [**Chiapas**]{style="color:#e94560;"}, 66 de cada 100 personas viven en pobreza. En [**Baja California**]{style="color:#0f9b8e;"}, apenas 10. Esta diferencia no es mala suerte. Es estructura.
:::
...
::: {.ashira-insight .accent-green}
Cuando el ingreso laboral no alcanza, el sur sobrevive de dos maneras: programas gubernamentales y remesas. La mejora es real, pero frágil. Descansa en transferencias, no en trabajo formal.
:::
...
::: {.ashira-insight .accent-red}
El Sur está perdiendo lo más valioso que tiene: su gente. Los datos muestran una realidad cruda: a mayor pobreza, más emigración. Aunque el dinero que mandan los que se van **(remesas)** infla los números de ingreso y hace parecer que el estado mejora, la realidad es otra. [**No es progreso, es el resultado de jóvenes abandonando su hogar porque en su tierra no hay futuro.**]{style="color:#e94560;"}
:::
...
::: {.ashira-globe-intro}
La migración neta dice *cuántos se van*. El origen-destino dice **adónde van**. El patrón es consistente: el Sur alimenta al Norte y a los centros turísticos, los únicos mercados laborales que todavía absorben trabajadores sin credenciales universitarias.
:::
...
::: {.fig-caption style="font-size:0.85em; color:#5a6e84; margin-top:8px;"}
Figura 12: Flujos de migración interestatal 2015–2020 · Top 40 pares por volumen. Puntos: balance neto (azul = receptor, rojo = emisor).
[Fuente: Migración origen-destino, Censo de Población y Vivienda 2020, INEGI.]{.fig-source}
:::
:::

::: {.ashira-paradoja}
### ¿Por qué bajan los números pero no la pobreza?

Los estados del Sur cambian porque pierden gente, no porque ganen oportunidades. Cuando alguien migra buscando trabajo, su pobreza simplemente se muda de casa.

**La estadística engaña:** El Sur parece mejorar porque su base poblacional se reduce.

**La pobreza se esconde:** En ciudades ricas, la pobreza del migrante se vuelve invisible frente al promedio general.

**La verdadera meta:** No basta con "limpiar" las cifras de un estado; hay que generar riqueza donde la gente vive.
...
::: {.ashira-insight .accent-teal}
Cada indicador cuenta una parte. Juntos revelan el patrón: [**los mismos estados aparecen siempre arriba en pobreza, informalidad, remesas e inseguridad alimentaria.**]{style="color:#0f9b8e;"} No es azar. Es estructura.
:::
...
En los últimos 20 años, Aguascalientes y Querétaro lograron reducir su pobreza y subir su ingreso mediano. Brasil redujo la pobreza extrema un 58% entre 2003 y 2014 con Bolsa Família. Colombia redujo la pobreza multidimensional de 30% a 18% con Familias en Acción. [**La convergencia es posible cuando las intervenciones son focalizadas, sostenidas y medidas públicamente.**]{style="color:#38bdf8;"}
:::
...
Este análisis se actualizará cuando INEGI publique ENIGH 2026. El código y los datos están disponibles en GitHub bajo licencia **Creative Commons CC BY 4.0**. Si detectas un error, quieres colaborar, o quieres usar estos datos como funcionario, investigador o periodista, escríbenos: [equipo ASHIRA](mailto:asharet.b@gmail.com).
:::
...
La Agenda 2030 no pide promedios. Pide que nadie se quede atrás. [**Este análisis muestra que en México, el lugar donde naciste todavía decide si te quedas o te vas.**]{.closing-quote}
:::
...
[asharet.b@gmail.com](mailto:asharet.b@gmail.com){.footer-contact}
:::
