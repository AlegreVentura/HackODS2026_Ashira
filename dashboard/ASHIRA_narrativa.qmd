...
// Plotly resize cuando se cambia de tab (los charts en tabs ocultos se renderizan con ancho incorrecto)
...
<div style="background:#0d1117; padding:36px 44px; border-radius:14px; border:1px solid #21262d; margin:24px 0 16px 0;">
<p style="color:#c9d1d9; font-size:1.1em; line-height:1.7; margin:0;">Cada estado coloreado por su porcentaje de pobreza multidimensional en 2024. El patrón es inmediato: <strong style="color:#2ecc71;">el norte es verde</strong>, <strong style="color:#e94560;">el sur es rojo.</strong> No hay excepciones.</p>
</div>
...
fig.update_geos(
    visible=False,
    bgcolor=BG, projection_type="mercator",
...
fig.update_layout(
    ...
    geo=dict(**geo_cfg,  lakecolor=BG, landcolor=BG),
    geo2=dict(**geo_cfg, lakecolor=BG, landcolor=BG),
    title=dict(
...
<div style="background:linear-gradient(135deg,#1a1a2e,#16213e); padding:36px 44px; border-radius:14px; border-left:7px solid #f5a623; margin:24px 0 16px 0;">
<p style="color:#c9d1d9; font-size:1.15em; line-height:1.75; margin:0;">En ocho años, el ingreso en México subió para todos, pero de forma profundamente desigual. El Sur no está estancado, pero su ritmo no alcanza para seguirle el paso al Norte. La brecha no se cierra. <strong style="color:#f5a623;">El código postal sigue pesando más que el esfuerzo.</strong></p>
</div>
...
<div style="background:linear-gradient(135deg,#1a1a2e,#16213e); padding:36px 44px; border-radius:14px; border-left:7px solid #7b68ee; margin:24px 0 16px 0;">
<p style="color:#c9d1d9; font-size:1.15em; line-height:1.75; margin:0;">La pobreza en México no es aleatoria. Tiene raíces en la historia, en la etnicidad, en el mercado de trabajo. <strong style="color:#7b68ee;">No es coincidencia. Es estructura.</strong></p>
</div>
...
<div style="background:linear-gradient(135deg,#1a1a2e,#16213e); padding:36px 44px; border-radius:14px; border-left:7px solid #2ecc71; margin:24px 0 16px 0;">
<p style="color:#c9d1d9; font-size:1.15em; line-height:1.75; margin:0;">Cuando el ingreso laboral no alcanza, el sur sobrevive de dos maneras: programas gubernamentales y remesas. La mejora es real, pero frágil. Descansa en transferencias, no en trabajo formal.</p>
</div>
...
<p style="color:#c9d1d9; font-size:1.05em; line-height:1.75; margin:0 0 16px 0;">Los estados del Sur cambian porque pierden gente, no porque ganen oportunidades. Cuando alguien migra buscando trabajo, su pobreza simplemente se muda de casa.</p>
<p style="color:#c9d1d9; font-size:1.03em; line-height:1.72; margin:0 0 10px 0;"><strong style="color:#e6edf3;">La estadística engaña:</strong> El Sur parece mejorar porque su base poblacional se reduce.</p>
<p style="color:#c9d1d9; font-size:1.03em; line-height:1.72; margin:0 0 10px 0;"><strong style="color:#e6edf3;">La pobreza se esconde:</strong> En ciudades ricas, la pobreza del migrante se vuelve invisible frente al promedio general.</p>
<p style="color:#c9d1d9; font-size:1.03em; line-height:1.72; margin:0;"><strong style="color:#e6edf3;">La verdadera meta:</strong> No basta con "limpiar" las cifras de un estado; hay que generar riqueza donde la gente vive.</p>
...
<div style="background:linear-gradient(135deg,#1a1a2e,#16213e); padding:36px 44px; border-radius:14px; border-left:7px solid #0f9b8e; margin:24px 0 16px 0;">
<p style="color:#c9d1d9; font-size:1.15em; line-height:1.75; margin:0;">Cada indicador cuenta una parte. Juntos revelan el patrón: <strong style="color:#0f9b8e;">los mismos estados aparecen siempre arriba en pobreza, informalidad, remesas e inseguridad alimentaria.</strong> No es azar. Es estructura.</p>
</div>
...
<footer class="ashira-footer">
  <div class="ashira-footer-inner">
    ...
    <div class="ashira-footer-sources">
      ...
      <span>ENIGH 2016–2024 · PM CONEVAL 2024 · Censo 2020 · ICE IMCO 2020</span>
