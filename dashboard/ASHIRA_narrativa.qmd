...
_html_globe = f"""
<div style="font-family:Inter,sans-serif;border-radius:14px;overflow:hidden;margin:8px 0 4px;background:#000;">
  <div style="padding:22px 30px 10px;background:#000;">
    <h3 style="color:#c9d1d9;margin:0 0 5px;font-family:Fraunces,serif;font-size:1.25em;font-weight:600;">
      &#191;Ad&#243;nde va la gente que se va?
    </h3>
    <p style="color:#8b949e;margin:0;font-size:0.85em;">
  ...
  <div id="globe-flujo-ashira" style="width:100%;height:660px;background:#040c18;display:flex;align-items:center;justify-content:center;">
    <span id="globe-loading-msg" style="color:#484f58;font-size:13px;font-family:Inter,sans-serif;">Cargando globo WebGL...</span>
  </div>
  <div style="padding:10px 30px 18px;background:#000;display:flex;gap:20px;align-items:center;flex-wrap:wrap;">
    <span style="display:flex;align-items:center;gap:7px;">
      <span style="width:11px;height:11px;border-radius:50%;background:#26c6da;display:inline-block;"></span>
      <span style="color:#8b949e;font-size:0.8em;">Recibe m&#225;s migrantes de los que env&#237;a</span>
    </span>
    <span style="display:flex;align-items:center;gap:7px;">
      <span style="width:11px;height:11px;border-radius:50%;background:#ff5252;display:inline-block;"></span>
      <span style="color:#8b949e;font-size:0.8em;">Pierde m&#225;s poblaci&#243;n de la que recibe</span>
    </span>
    <span style="margin-left:auto;color:#3d444d;font-size:0.75em;">
      Fuente: INEGI &middot; Tabulados Complementarios Censo 2020
    </span>
  </div>
</div>
...
<!-- Paso 2: librería Globe.gl (carga síncrona; el paso 3 espera a que esto termine) -->
<script src="https://cdn.jsdelivr.net/npm/globe.gl/dist/globe.gl.min.js"></script>

<!-- Paso 3: inicialización (Globe ya está disponible) -->
<script>
(function(){{
  var el=document.getElementById('globe-flujo-ashira');
  var msg=document.getElementById('globe-loading-msg');
  if(!el)return;
  if(!window.Globe){{
    if(msg)msg.textContent='Error: Globe.gl no se pudo cargar (verifica conexión a internet).';
    return;
  }}
  if(msg){{msg.style.display='none';el.style.display='block';}}
  var ARC_COLORS=[
    ['rgba(30,100,255,0.22)','rgba(80,160,255,0.62)'],
    ['rgba(0,170,230,0.28)','rgba(0,210,255,0.68)'],
    ['rgba(0,220,230,0.34)','rgba(0,255,240,0.78)'],
    ['rgba(255,155,0,0.38)','rgba(255,200,50,0.82)'],
    ['rgba(255,65,0,0.44)','rgba(255,110,40,0.94)']
  ];
  ...
  try{{
    var g=Globe()
      ...
      .polygonCapColor(function(){{return '#0d1a26';}})
      .polygonSideColor(function(){{return '#0a141e';}})
      .polygonStrokeColor(function(){{return '#1e4060';}})
      ...
      .arcAltitude(function(d){{return 0.05+d.q*0.05;}})
      .arcStroke(function(d){{return 0.35+d.q*0.32;}})
      .arcDashLength(0.38)
      .arcDashGap(0.62)
      .arcDashInitialGap(function(d){{return Math.random();}})
      .arcDashAnimateTime(function(d){{return 1100+(4-d.q)*950;}})
      .arcLabel(function(d){{
      ...
      .pointAltitude(0.018)
      .pointRadius(function(d){{return 0.18+0.52*Math.pow(d.tot/maxTot,0.4);}})
      ...
      (el);
    g.pointOfView({{lat:23.5,lng:-102,altitude:1.22}},0);
    g.controls().enableZoom=true;
    g.controls().autoRotate=false;
    g.controls().enablePan=false;
    g.controls().minPolarAngle=Math.PI*0.15;
    g.controls().maxPolarAngle=Math.PI*0.85;
  }}catch(e){{
