...
<div style="text-align:center; margin: 10px 0;">
  <img src="untitled.GIF" alt="Flujos de migración interestatal 2015–2020" style="max-width:100%; border-radius:8px;" />
  <p class="fig-caption" style="font-size:0.85em; color:#5a6e84; margin-top:8px;">
    Figura 12: Flujos de migración interestatal 2015–2020 · Top 40 pares por volumen. Puntos: balance neto (azul = receptor, rojo = emisor).<br>
    <span class='fig-source'>Fuente: Migración origen-destino, Censo de Población y Vivienda 2020, INEGI.</span>
  </p>
</div>
...
<a href="mailto:asharet.b@gmail.com" class="footer-contact">asharet.b@gmail.com</a>
:::
