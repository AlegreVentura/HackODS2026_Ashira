...
def extraer_valores_estado(filepath, sheet, col_indices, col_names,
    ...
    """Lee un tabulado Censo 2020 y devuelve un DataFrame con una fila por entidad,
    filtrando solo Sexo=Total y Estimador=Valor. col_indices/col_names mapean
    columnas del XLSX a nombres de salida."""
